    ...
    */
    ...
    function shortcode_editor_timeline_preview_append() {
      if( !function_exists('fv_player_editor_input') ):
        ...
        if(isset($_GET['fv_thumbs'])):
          ?>
          <tr>
            <th scope="row" class="label"></th>
            <td class="field fv-fp-timeline-preview-generate" colspan="2">
              <a class="button fv_generate_vtt_sprite" href="#"><?php _e('Generate', 'fv_flowplayer'); ?></a>
              <input type="hidden" name="fv_wp_flowplayer_field_timeline_previews_job_id" id="timeline_previews_job_id" class="fv_wp_flowplayer_field_timeline_previews_job_id" />
              <input type="hidden" name="fv_wp_flowplayer_field_timeline_previews_job_status" id="timeline_previews_job_status" class="fv_wp_flowplayer_field_timeline_previews_job_status" />
              <a href="#" onclick="jQuery('#fv-fp-timeline-preview-generate-help').toggle(); return false" class="show-info"><span class="dashicons dashicons-info"></span></a>
              <span id="fv-fp-timeline-preview-generate-help" style="display: none">Uses the Foliovision servers.</span>
              <span style="display: none; position: static" id="fv-player-shortcode-editor-generate-spinner" class="fv-player-shortcode-editor-small-spinner">&nbsp;</span>
            </td>
          </tr>
          <?php
        endif;
    ...
    function shortcode_subtitles_tab_fields($fields) {
      ...
      if ( isset( $_GET['fv_thumbs'] ) || defined( 'FV_PLAYER_TIMELINE_PREVIEWS_GENERATOR' ) ) {
        $fields['video']['items'][] = array(
          'label' => __('Timeline Previews Generator', 'fv-wordpress-flowplayer'),
          'name' => 'timeline_previews_generate',
          'type' => 'notice_info',
          'content' => '<a class="button fv_generate_vtt_sprite" href="#">' . __('Generate', 'fv_flowplayer') . '</a>
          <input type="hidden" name="fv_wp_flowplayer_field_timeline_previews_job_id" id="timeline_previews_job_id" class="fv_wp_flowplayer_field_timeline_previews_job_id" />
          <input type="hidden" name="fv_wp_flowplayer_field_timeline_previews_job_status" id="timeline_previews_job_status" class="fv_wp_flowplayer_field_timeline_previews_job_status" />
          <a href="#" onclick="jQuery(\'#fv-fp-timeline-preview-generate-help\').toggle(); return false" class="show-info"><span class="dashicons dashicons-info"></span></a>
          <span id="fv-fp-timeline-preview-generate-help" style="display: none">Uses the Foliovision servers.</span>
