...
if( !class_exists('FV_Player_Pro_DigitalOcean_Spaces') ) :

class FV_Player_Pro_DigitalOcean_Spaces extends FV_Player_Pro_Ajax_Loader {
    ...
    <table class="form-table2" style="margin: 5px; ">
      ...
      <tr>
        <td colspan="4">
          ...
          <a class="button fv-help-link" href="https://foliovision.com/player/video-security/encoding/encrypted-hls-coconut" target="_blank">Help</a>
        </td>
      </tr>
    </table>
    <?php
...
global $FV_Player_Pro_DigitalOcean_Spaces;
$FV_Player_Pro_DigitalOcean_Spaces = new FV_Player_Pro_DigitalOcean_Spaces;
